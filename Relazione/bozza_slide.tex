...
\begin{frame}
 ...
 \begin{itemize}
  \item Francesco Cerio
      \begin{itemize}
	\item SO: MacOS Catalina
    \item Editor: Atom
    \item Server Locale: MAMP
    \item GitLab: estensione Git Atom / GitHub Desktop
  \end{itemize}
  \item Matteo Celani
      \begin{itemize}
	\item SO: MacOS Mojave
    \item Editor: Atom
    \item Server Locale: MAMP
    \item GitLab: GitHub Desktop
  \end{itemize}
\end{itemize}
    \end{column}
    \hfill
  ...
  \begin{itemize}
	\item SO: MacOS Catalina
    \item Editor: Atom
    \item Server Locale: NodeJS da terminale
    \item GitLab: GitHub Desktop
  \end{itemize}
  \item Umberto Case
    \begin{itemize}
    ...
    \item Editor: Atom
    \item Server Locale:
    \item GitLab: estensione Git Atom
  \end{itemize}
\end{itemize}
    \end{column}
  \end{columns}
